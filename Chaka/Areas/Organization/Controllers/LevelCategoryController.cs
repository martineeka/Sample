...
namespace Chaka.Areas.Organization.Controllers
{
    ...
    {
        string url = ApiUrl.OrganizationUrl + "LevelCategory";
        ...
        public JsonResult List([DataSourceRequest] DataSourceRequest request)
        {
            ...
            try
            {
                ...
                var result = Utilities.RestAPIHelper<CustomDataSourceResult<ListLevelCategoryViewModel>>
        ...
        public ActionResult GetCategoryLevel()
        {
            ...
            try
            {
                var endpoint = url + "/CategoryLevel";
        ...
        [HttpGet]
        public ActionResult ValidateLevelCategoryCode(string code, string id)
        {
            var endpoint = url + "/ValidateLevelCategoryCode/" + code + "/" + id;
