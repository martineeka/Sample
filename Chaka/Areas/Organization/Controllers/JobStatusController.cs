...
namespace Chaka.Areas.Organization.Controllers
{
    ...
    {
        string url = ApiUrl.OrganizationUrl + "JobStatus";
        ...
        public JsonResult List([DataSourceRequest] DataSourceRequest request)
        {
            ...
            try
            {
                ...
                var result = Utilities.RestAPIHelper<CustomDataSourceResult<ListJobStatusViewModel>>
        ...
        public ActionResult Edit(CreateEditViewModel model)
        {
            ...
            try
            {
                var checkCode = Utilities.RestAPIHelper<string>
                                  .Submit("", Method.GET, url + "/ValidateJobStatusCode/" + model.Code + "/" + model.ID);
                if (Convert.ToBoolean(checkCode) == true)
                {
                    jsonViewModel.SetValues(false, null, String.Format("Job Status Code has been used"));
                }
                else
                {
        ...
        [HttpGet]
        public ActionResult ValidateJobStatusCode(string code, string id)
        {
            var endpoint = url + "/ValidateJobStatusCode/" + code + "/" + id;
