...
namespace Chaka.Areas.Organization.Controllers
{
    ...
    {
        string url = String.Format("{0}{1}", ApiUrl.OrganizationUrl, "LineOfBusiness");
        ...
        public JsonResult List([DataSourceRequest] DataSourceRequest request)
        {
            ...
            try
            {
                ...
                var result = Utilities.RestAPIHelper<CustomDataSourceResult<ListLineOfBusinessViewModel>>
