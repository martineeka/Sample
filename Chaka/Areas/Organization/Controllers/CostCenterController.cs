...
namespace Chaka.Areas.Organization.Controllers
{
    ...
    {
        string url = String.Format("{0}CostCenter", ApiUrl.OrganizationUrl);
        ...
        public JsonResult List([DataSourceRequest] DataSourceRequest request)
        {
            ...
            try
            {
                ...
                var result = Utilities.RestAPIHelper<CustomDataSourceResult<ListCostCenterViewModel>>
        ...
        public ActionResult Delete(string[] arrayOfID)
        {
            ...
            try
            {
                ...
                if (Convert.ToBoolean(result))
                    ajaxViewModel.SetValues(false, null, "Cost Center already used by Organization Unit");
                else
