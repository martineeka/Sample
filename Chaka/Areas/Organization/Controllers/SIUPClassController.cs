...
{
    [Area("Organization")]
    public class SIUPClassController : Controller
    {
        string url = String.Format("{0}SIUPClass", ApiUrl.OrganizationUrl);
        ...
        public JsonResult List([DataSourceRequest] DataSourceRequest request)
        {
            ...
            try
            {
                ...
                var result = Utilities.RestAPIHelper<CustomDataSourceResult<ListSIUPClassViewModel>>
        ...
        public ActionResult Delete(string[] arrayOfID)
        {
            ...
            try
            {
                ...
                if (Convert.ToBoolean(result))
                    ajaxViewModel.SetValues(false, null, "SIUP Class already used by Legal Entity");
                else
