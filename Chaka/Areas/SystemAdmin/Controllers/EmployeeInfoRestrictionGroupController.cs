...
{
    [Area("SystemAdmin")]
    public class EmployeeInfoRestrictionGroupController : Controller
    {
        string url = ApiUrl.SecurityUrl + "EmployeeInfoRestrictionGroup";
        ...
        public ActionResult EditRestriction(string id)
        {
            var jsonViewModel = new AjaxViewModel();
            CreateEditViewModel model = new CreateEditViewModel();
            try
            ...
            return PartialView("CreateEditRestriction", model);
        }

        [HttpPost]
        public ActionResult EditRestriction(CreateEditViewModel model)
        {
            var jsonViewModel = new AjaxViewModel();
            try
            {
